...
<head>
    ...
    <link rel="stylesheet" href="/css/cuenta_contable_tabla.css">
    <script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <title>Busqueda Cuenta Contable</title>
</head>

<body>
    <header>
        <h1> Busqueda Cuenta Contable </h1>
    </header>
    <nav class="menu">
    ...
    <main>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
            <div class="form-group">
                <label for="name" id="sku">Nombre Cuenta</label>
            ...
            if (isset($_POST['submit'])) {
                ...
                try {
                    ...
                    $contador = (
                        "SELECT count(cuenta) as numero from cuentas
                            where descripcion like $csku"
                    );
